...
export async function generateMetadata({
  ...
  const book = books.find((item) => item.slug ===import type { Metadata } from "next";
import Image from "next/image";
import Link from "next/link";
import { books } from "@/data/books";
      ...
      <section className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[380px_1fr]">
        ...
        <div>
          ...
          <Link
            ...
            className="mx-auto mt-8 block w-fit rounded-full bg-[#ff2f8f] px-8 py-3 font-semibold text-black lg:mx-0"
          >
            View on Amazon
          </Link>
        </div>
